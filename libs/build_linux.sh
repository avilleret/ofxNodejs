...
ar x ./out/Release/libcares.a
ar x ./out/Release/libchrome_zlib.a
ar x ./out/Release/libhttp_parser.a
ar x ./out/Release/libnode.a
ar x ./out/Release/libopenssl.a
ar x ./out/Release/libuv.a
ar x ./out/Release/libv8_base.a
ar x ./out/Release/libv8_nosnapshot.a
ar x ./out/Release/libv8_snapshot.a
ar rcs libnode.a *.o
rm *.o

# copy
mkdir -p ../../node/lib/linux/
cp libnode.a ../../node/lib/linux/libnode.a
